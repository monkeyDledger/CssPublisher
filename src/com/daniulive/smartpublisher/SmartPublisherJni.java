...
public class SmartPublisherJni {
     ...
     * 
     * @param kbps:
     *            the kbps of different resolution(25 fps).
     * 
     * @return {0} if successful
     */
     ...
     * 
     * @param fontSize:
     *            it should be "MEDIUM", "SMALL", "BIG"
     * 
     * @param waterPostion:
     *            it should be "TOPLEFT", "TOPRIGHT", "BOTTOMLEFT",
     *            "BOTTOMRIGHT".
     * 
     * @param xPading,
     *            yPading: the distance of the original picture.
     * 
     *            <pre>
     ...
     * @return {0} if successful
     */
    public native int SmartPublisherSetFontWatermark(String waterText, int isAppendTime, int fontSize, int waterPostion,
	    int xPading, int yPading);

    /**
     * Set picture water-mark
     * 
     * @param picPath:
     *            the picture working path, e.g: /sdcard/logo.png
     * 
     * @param waterPostion:
     *            it should be "TOPLEFT", "TOPRIGHT", "BOTTOMLEFT",
     *            "BOTTOMRIGHT".
     * 
     * @param picWidth,
     *            picHeight: picture width & height
     * 
     * @param xPading,
     *            yPading: the distance of the original picture.
     * 
     ...
     * @return {0} if successful
     */
    public native int SmartPublisherSetPictureWatermark(String picPath, int waterPostion, int picWidth, int picHeight,
	    int xPading, int yPading);
     ...
     * 
     * @param isMute:
     *            if with 1:mute, if with 0: does not mute
     * 
     * @return {0} if successful
     */
     ...
     * 
     * @param isKeyFrame:
     *            if with key frame, please set 1, otherwise, set 0.
     * 
     * @param timeStamp:
     *            video timestamp
     *
     ...
     * 
     *            byte[] audioConfig = new byte[2]; audioConfig[0] = 0x12;
     *            audioConfig[1] = 0x10;
     * 
     * @param len:
     *            buffer length
